...
namespace w_internal {
    ...
    template <class Func>
    struct isConstMemberMethod : std::false_type
    {
    };
    template <class Ret, class Obj, class... Args>
    struct isConstMemberMethod<Ret (Obj::*)(Args...) const> : std::true_type
    {
    };
    template <class Ret, class Obj, class... Args>
    struct isConstMemberMethod<Ret (Obj::*)(Args...) const noexcept> : std::true_type
    {
    };
#endif
...
template <typename W_Flag>                                                  \
Q_DECL_UNUSED static inline constexpr int w_flagAlias(W_Flag)               \
{                                                                           \
